...
nuėmę komentarą (//) nuo eilutės nr. 52 . Paleidus kodą, atkomentuotos eilutės neturėtų matytis
*/
...
// 6. Sukurkite 2 kintamuosius - "vardas" ir "pavarde". Apjunkite juos i viena stringa ir isspausdinkite i terminala.

// 7. Sukurkite kintamaji, kuris bus nuoroda i "pavarde" kintamaji (is 1 uzduoties). Pakeiskite naujojo kintamojo reiksme ir isspausdinkite kintamaji "pavarde".

// 8. Apibrezkite konstanta AMZIUS ir priskirkite jai reiksme. Apjunkite "vardas", "pavarde" ir AMZIUS ir issausdinkite.

// 9. Sukurkite boolean tipo kintamuosius "mokaAngluKalba" ir "mokaPrancuzuKalba". Sukurkite kintamaji boolean tipo kintamaji "mokaDaugKalbu", kuris parodytu ar zmogus moka daug kalbu ar tik viena.
